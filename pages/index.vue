    ...
    >
      <div class="w-full">
        <div class="space-y-8">
          ...
          <div class="space-y-4">
            <p
              class="text-white text-4xl md:text-5xl font-bold animate-float-delay-1"
            >
            ...
            <p
              class="text-white text-3xl md:text-4xl font-bold mt-8 animate-float-delay-5"
            >
